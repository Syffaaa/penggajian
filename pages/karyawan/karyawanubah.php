    ...
    <div class="col">
        ...
        <?php
            ...
            if (!$result_bagian) {
                ...
                ?>
                <select class="form-select" aria-label="Defalut select example" name="bagian_id">
                    <option value="" selected> -- Pilih Bagian -- </option>
                    <?php
                    while($row_bagian=mysqli_fetch_assoc($result_bagian)){
                        $bagian_select = $row["bagian_id"]==$row_bagian["id"]? " selected": "";
                        ?>
                        <option value="<?php echo $row_bagian["id"] ?>"><?php echo $bagian_select ?>>
                    <?php echo $row_bagian["naa"]?></option>
                        <?php
                    }
                    ?>
                </select>
